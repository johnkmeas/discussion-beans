...
<div id="buddypress">
    ...
    <div class="page" id="register-page">
        ...
        <?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
            ...
            <p><?php _e( 'Registering for FNSA Disussion site is easy. Just fill in the fields below, and we\'ll get a new account set up for you in no time.<br>For assistance, email us at<a href="mailto:fnsa@fnesc.ca"> fnsa@fnesc.ca</a> or call <a href="tel:1-877-422-3672">1-877-422-3672</a>', 'buddypress' ); ?></p>
